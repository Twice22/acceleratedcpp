...
public:
	...
	*/
	...
	// Answer to Q11.7 (need to add empty method)
	bool empty() const { return avail == data; };
...
void Vec<T>::create(size_type n, const T& val) {
	...
	uninitialized_fill(data, limit, val); // copy val into the sequence of uninitialized elements
}
